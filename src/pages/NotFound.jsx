  ...
  return (
    <>
      <SEO
        ...
        description={`This page doesn't exist. Generate a free UK meal plan or browse ${PLAN_COUNT_LABEL} ready-made plans.`}
        canonical="/404"
      ...
      <div className="page not-found-page">
        <div className="not-found-content">
          ...
          <div className="not-found-actions">
            ...
            <Link to="/browse" className="btn-secondary">Browse {PLAN_COUNT_LABEL} ready-made plans</Link>
          </div>
        </div>
      </div>
      <Footer />
