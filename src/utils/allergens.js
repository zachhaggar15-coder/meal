...
const FOOD_ALLERGENS = {
  ...
  'stir-fry sauce': { contains: ['soya'], varies: ['gluten', 'sesame'] },
  ...
  'balsamic vinegar': { contains: ['sulphites'] },
  // Generic vinegar covers wine vinegars (sulphites) and malt vinegar (barley).
  'vinegar': { varies: ['sulphites', 'gluten'] },
