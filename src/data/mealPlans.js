...
const BASE_SHOPPING = {
  ...
  'tesco-low-calorie-meal-plan': {
    protein: ['Tesco British Chicken Breast Fillets (1 kg)', 'Tesco Tuna Chunks in Spring Water (4 x 145 g)', 'Tesco Medium Free Range Eggs (12)', 'Tesco 0% Fat Greek Style Yogurt (1 kg)', 'Tesco British Turkey Breast Mince 2% Fat (500 g)', 'Tesco 2 Boneless Salmon Fillets (260 g)'],
    carbs: ["Grower's Harvest Porridge Oats (1 kg)", 'Tesco Wholemeal Sliced Bread (800 g)', 'Tesco Easy Cook Brown Rice (1 kg)', 'Tesco Sweet Potatoes (1 kg)', 'Tesco Wholemeal Pitta Breads (6 pack)'],
    vegetables: ['Tesco Large Broccoli Pack (500 g)', 'Tesco Baby Spinach (200 g)', 'Tesco Salad Bag (200 g)', 'Tesco Cherry Tomatoes (400 g)', 'Growers Harvest Mixed Vegetables (1 kg)', 'Carrots (1 kg)'],
    dairy: ['Tesco Filtered Skimmed Milk (2 L)', 'Tesco Low Fat Cottage Cheese (300 g)'],
    extras: ['Tesco Reduced Fat Houmous (200 g)', 'Tesco Perfectly Imperfect Frozen Mixed Berries (1 kg)', 'Tesco Olive Oil Spray (190 ml)', 'Tinned tomatoes and kidney beans for chilli'],
  },
...
export const PLAN_1500 = [
  ...
  { day: 'Tuesday', meals: [
    ...
    { type: 'Lunch', name: 'Homemade Lentil Soup', kcal: 463, protein: 26, prep: '30 min', desc: 'Red lentil and carrot soup seasoned with cumin and coriander, served with a small wholemeal roll.', portion_size: '80g red lentils (dry), 100g carrots, 1 small roll (60g), Cumin optional to taste (excluded from nutrition estimate), Ground coriander optional to taste (excluded from nutrition estimate)' },
    { type: 'Dinner', name: 'Baked Salmon with Broccoli & New Potatoes', kcal: 452, protein: 37, prep: '20 min', desc: 'Salmon fillet baked with lemon and dill, served with steamed broccoli and boiled new potatoes.', portion_size: '150g salmon fillet, 150g new potatoes, 150g broccoli, Lemon juice optional to taste (excluded from nutrition estimate), Dill optional to taste (excluded from nutrition estimate)' },
    { type: 'Snack', name: 'Apple & Almonds', kcal: 194, protein: 5, prep: '1 min', desc: 'One medium apple and 20 g of unsalted almonds.', portion_size: '1 apple (150g), 20g almonds' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Grilled Chicken Caesar Salad', kcal: 222, protein: 32, prep: '10 min', desc: 'Chicken breast strips over romaine lettuce with a light Caesar dressing and Parmesan shavings. No croutons.', portion_size: '120g chicken breast, 80g romaine lettuce, 20ml light Caesar dressing, 10g parmesan' },
    { type: 'Dinner', name: 'Turkey Mince Chilli with Brown Rice', kcal: 459, protein: 42, prep: '25 min', desc: 'Lean turkey mince cooked with tinned tomatoes, kidney beans, and chilli spices. Served with brown rice.', portion_size: '150g turkey mince, 40g brown rice (dry), 80g kidney beans, 200g tinned tomatoes, Chilli powder optional to taste (excluded from nutrition estimate)' },
  ...
  { day: 'Thursday', meals: [
    { type: 'Breakfast', name: 'Porridge with Walnuts & Cinnamon', kcal: 371, protein: 18, prep: '5 min', desc: '50 g oats cooked with skimmed milk, topped with 15 g crushed walnuts and a sprinkle of cinnamon.', portion_size: '50g oats, 250ml skimmed milk, 15g walnuts' },
    { type: 'Lunch', name: 'Prawn & Avocado Salad', kcal: 219, protein: 25, prep: '10 min', desc: 'King prawns tossed with mixed leaves, half an avocado, cucumber, and lemon dressing.', portion_size: '120g king prawns, ½ avocado (60g), 80g mixed leaves, 100g cucumber, 15g lemon dressing' },
  ...
  { day: 'Friday', meals: [
    { type: 'Breakfast', name: 'Poached Eggs & Smoked Salmon on Toast', kcal: 338, protein: 29, prep: '10 min', desc: 'Two poached eggs and 50 g smoked salmon on a slice of wholemeal toast.', portion_size: '2 eggs, 50g smoked salmon, 1 slice wholemeal toast (35g)' },
    { type: 'Lunch', name: 'Chicken & Vegetable Soup', kcal: 215, protein: 29, prep: '25 min', desc: 'Diced chicken breast simmered with carrots, celery, and leek in a light chicken stock.', portion_size: '120g chicken breast, 80g carrots, 50g celery, 50g leek' },
    { type: 'Dinner', name: 'Baked Cod with Sweet Potato Wedges', kcal: 283, protein: 31, prep: '25 min', desc: 'Cod fillet baked with herbs and lemon, served with oven-roasted sweet potato wedges and green beans.', portion_size: '150g cod fillet, 150g sweet potato, 100g green beans, Mixed herbs optional to taste (excluded from nutrition estimate), Lemon juice optional to taste (excluded from nutrition estimate)' },
    { type: 'Snack', name: 'Protein Yogurt', kcal: 113, protein: 17, prep: '1 min', desc: 'High-protein low-fat yogurt pot (e.g. Arla Protein or Tesco High Protein Yogurt).', portion_size: '1 high-protein yogurt pot (150g)' },
  ...
  { day: 'Saturday', meals: [
    ...
    { type: 'Lunch', name: 'Turkey & Avocado Wholemeal Wrap', kcal: 372, protein: 29, prep: '5 min', desc: 'Sliced turkey breast, half an avocado, spinach, and tomato in a wholemeal tortilla wrap.', portion_size: '100g turkey breast, ½ avocado (60g), 1 wholemeal wrap (60g), 30g spinach, 50g tomato' },
    { type: 'Dinner', name: 'Grilled Lean Beef Steak with Roasted Veg', kcal: 290, protein: 37, prep: '15 min', desc: 'Lean sirloin steak grilled to your liking, with a mix of roasted vegetables.', portion_size: '150g lean sirloin steak, 200g roasted veg' },
  ...
  { day: 'Sunday', meals: [
    { type: 'Breakfast', name: 'Healthy Full English', kcal: 320, protein: 29, prep: '15 min', desc: 'One egg (grilled or poached), two lean bacon rashers (fat trimmed), grilled tomatoes, mushrooms, and one slice of wholemeal toast.', portion_size: '1 egg, 2 lean bacon rashers (60g), 100g tomatoes, 50g mushrooms, 1 slice toast' },
    { type: 'Lunch', name: 'Leftover Steak Salad', kcal: 179, protein: 24, prep: '5 min', desc: 'Sliced leftover steak over mixed leaves with cherry tomatoes and a balsamic dressing.', portion_size: '100g sliced steak, 80g mixed leaves, 100g cherry tomatoes, 15g balsamic dressing' },
    { type: 'Dinner', name: 'Roast Chicken Breast with Root Veg', kcal: 329, protein: 42, prep: '45 min', desc: 'Roast chicken breast with parsnips, carrots, and a small portion of gravy. A proper Sunday roast, lighter style.', portion_size: '175g chicken breast, 100g parsnips, 100g carrots, 50ml gravy' },
    { type: 'Snack', name: 'Protein Shake', kcal: 199, protein: 32, prep: '2 min', desc: 'One scoop of unflavoured or vanilla protein powder mixed with water or skimmed milk.', portion_size: '30g protein powder, 250ml skimmed milk' },
...
export const PLAN_HIGH_PROTEIN = [
  ...
  { day: 'Tuesday', meals: [
    ...
    { type: 'Lunch', name: 'Chicken & Quinoa Power Bowl', kcal: 426, protein: 44, prep: '15 min', desc: 'Grilled chicken breast sliced over 80 g cooked quinoa with edamame, cucumber, and tahini dressing.', portion_size: '140g chicken breast, 80g quinoa (cooked), 50g edamame, 100g cucumber, 1 tbsp tahini' },
    { type: 'Dinner', name: 'Baked Salmon with Asparagus', kcal: 477, protein: 37, prep: '20 min', desc: 'Salmon fillet baked with lemon and herbs, served with a bunch of roasted asparagus and a small side of brown rice.', portion_size: '150g salmon fillet, 200g asparagus, 40g brown rice (dry), Lemon juice optional to taste (excluded from nutrition estimate), Mixed herbs optional to taste (excluded from nutrition estimate)' },
    { type: 'Snack', name: 'Protein Shake & Almonds', kcal: 230, protein: 28, prep: '2 min', desc: 'One scoop protein powder mixed with water, plus 20 g almonds.', portion_size: '30g protein powder, 300ml water, 20g almonds' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Turkey & Lentil Soup', kcal: 352, protein: 44, prep: '30 min', desc: 'Ground turkey and red lentil soup with spinach and mild spices.', portion_size: '150g turkey mince, 40g red lentils (dry), 80g spinach, Mixed spices optional to taste (excluded from nutrition estimate)' },
    ...
    { type: 'Snack', name: 'Greek Yogurt & Walnuts', kcal: 205, protein: 17, prep: '2 min', desc: '150 g 0% Greek yogurt with 15 g walnuts and a teaspoon of honey.', portion_size: '150g 0% Greek yogurt, 15g walnuts, 1 tsp honey' },
  ...
  { day: 'Friday', meals: [
    ...
    { type: 'Lunch', name: 'Chicken & Chickpea Power Salad', kcal: 310, protein: 39, prep: '10 min', desc: 'Grilled chicken breast, 100 g drained chickpeas, cucumber, spinach, and lemon-garlic dressing.', portion_size: '130g chicken breast, 100g chickpeas (drained), 100g cucumber, 60g spinach, 15g lemon dressing' },
    { type: 'Dinner', name: 'Baked Cod with Lentils', kcal: 255, protein: 37, prep: '25 min', desc: 'Baked cod fillet on a bed of 100 g cooked green lentils with roasted tomatoes and a squeeze of lemon.', portion_size: '150g cod fillet, 100g cooked lentils, 100g roasted tomatoes' },
  ...
  { day: 'Saturday', meals: [
    ...
    { type: 'Lunch', name: 'Prawn & Quinoa Bowl', kcal: 320, protein: 34, prep: '10 min', desc: 'King prawns over 80 g quinoa with avocado, cucumber, and a ginger-soy dressing.', portion_size: '150g king prawns, 80g quinoa (cooked), ½ avocado (60g), 100g cucumber, 1 tbsp soy sauce' },
  ...
  { day: 'Sunday', meals: [
    ...
    { type: 'Lunch', name: 'Chicken & Vegetable Stew', kcal: 279, protein: 39, prep: '30 min', desc: 'Diced chicken breast slow-simmered with carrots, celery, and lentils.', portion_size: '150g chicken breast, 80g carrots, 60g celery, 50g lentils (dry)' },
...
export const PLAN_VEGAN = [
  { day: 'Monday', meals: [
    ...
    { type: 'Dinner', name: 'Tofu Stir-Fry with Brown Rice', kcal: 526, protein: 40, prep: '20 min', desc: 'Firm tofu cubes stir-fried with broccoli, peppers, and low-sodium soy sauce, served on brown rice.', portion_size: '200g firm tofu, 40g brown rice (dry), 150g broccoli, 100g peppers, 1 tbsp soy sauce' },
  ...
  { day: 'Tuesday', meals: [
    { type: 'Breakfast', name: 'Tofu Scramble on Wholemeal Toast', kcal: 334, protein: 30, prep: '10 min', desc: 'Crumbled firm tofu sautéed with turmeric, spinach, and cherry tomatoes, on wholemeal toast.', portion_size: '150g firm tofu, 1 slice wholemeal toast (35g), 80g spinach, 100g cherry tomatoes' },
    { type: 'Lunch', name: 'Red Lentil & Vegetable Soup', kcal: 495, protein: 27, prep: '30 min', desc: 'Thick red lentil soup with cumin, turmeric, carrot, and onion, with wholemeal bread.', portion_size: '80g red lentils (dry), 100g carrot, 80g onion, 1 small roll (60g)' },
    { type: 'Dinner', name: 'Mushroom & Lentil Bolognese', kcal: 472, protein: 28, prep: '25 min', desc: 'Finely chopped mushrooms and green lentils in a rich tomato sauce, served over wholemeal spaghetti.', portion_size: '80g wholemeal spaghetti (dry), 200g mushrooms, 100g cooked lentils, 200g tinned tomatoes, Mixed herbs optional to taste (excluded from nutrition estimate)' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Tofu & Quinoa Buddha Bowl', kcal: 542, protein: 32, prep: '15 min', desc: 'Baked marinated tofu over 80 g quinoa with roasted peppers, cucumber, avocado, and tahini dressing.', portion_size: '150g baked tofu, 80g quinoa (cooked), 100g roasted peppers, ½ avocado (60g), 1 tbsp tahini, 100g cucumber' },
    { type: 'Dinner', name: 'Black Bean & Sweet Potato Curry', kcal: 794, protein: 29, prep: '25 min', desc: 'Black beans and diced sweet potato in a coconut milk curry sauce with spinach and brown rice.', portion_size: '240g black beans (drained), 200g sweet potato, 100ml coconut milk, 40g brown rice (dry), 100g spinach' },
  ...
  { day: 'Thursday', meals: [
    ...
    { type: 'Dinner', name: 'Tofu & Lentil Curry', kcal: 502, protein: 24, prep: '25 min', desc: 'Silken tofu with green lentils in a tomato-based curry sauce, served with a small portion of brown rice.', portion_size: '200g silken tofu, 80g cooked lentils, 200ml tomato curry sauce, 40g brown rice (dry)' },
  ...
  { day: 'Friday', meals: [
    { type: 'Breakfast', name: 'Avocado Toast with Nutritional Yeast', kcal: 371, protein: 22, prep: '10 min', desc: 'Two slices wholemeal toast topped with half an avocado, tomato, and nutritional yeast.', portion_size: '2 slices wholemeal toast (70g), ½ avocado (60g), 100g tomato, 2 tbsp nutritional yeast' },
    ...
    { type: 'Dinner', name: 'Vegetarian Chilli (Vegan)', kcal: 524, protein: 29, prep: '25 min', desc: 'Kidney beans, black beans, and lentils in a smoky tomato chilli, served with brown rice.', portion_size: '120g kidney beans, 120g black beans, 80g cooked lentils, 40g brown rice (dry), 200g tinned tomatoes, Smoked paprika optional to taste (excluded from nutrition estimate)' },
  ...
  { day: 'Saturday', meals: [
    { type: 'Breakfast', name: 'Tofu Scramble with Mushrooms', kcal: 437, protein: 51, prep: '10 min', desc: 'Crumbled tofu sautéed with mushrooms, spinach, and nutritional yeast for a cheesy flavour.', portion_size: '200g firm tofu, 150g mushrooms, 80g spinach, 2 tbsp nutritional yeast' },
    { type: 'Lunch', name: 'Lentil & Roasted Veg Bowl', kcal: 319, protein: 15, prep: '30 min', desc: 'Roasted butternut squash, courgette, and peppers over green lentils with tahini dressing.', portion_size: '100g cooked lentils, 150g butternut squash, 100g courgette, 100g peppers, 1 tbsp tahini' },
  ...
  { day: 'Sunday', meals: [
    ...
    { type: 'Lunch', name: 'Tomato & Chickpea Salad', kcal: 454, protein: 21, prep: '10 min', desc: 'Cherry tomatoes, basil, chickpeas, rocket, and olive oil-balsamic dressing.', portion_size: '240g chickpeas (drained), 200g cherry tomatoes, 40g rocket, 1 tbsp olive oil, 1 tsp balsamic glaze' },
    { type: 'Dinner', name: 'Lentil Bolognese with Wholemeal Pasta', kcal: 484, protein: 28, prep: '30 min', desc: 'Brown lentils in a rich tomato sauce with mushrooms and herbs, served over wholemeal pasta.', portion_size: '80g wholemeal pasta (dry), 120g cooked lentils, 150g mushrooms, 200g tinned tomatoes, Mixed herbs optional to taste (excluded from nutrition estimate)' },
...
export const PLAN_VEGETARIAN = [
  { day: 'Monday', meals: [
    ...
    { type: 'Lunch', name: 'Chickpea & Spinach Salad', kcal: 418, protein: 24, prep: '10 min', desc: 'Tinned chickpeas, baby spinach, cherry tomatoes, cucumber, red onion, and lemon-tahini dressing.', portion_size: '240g chickpeas (drained), 60g baby spinach, 150g cherry tomatoes, 1 tbsp tahini (15g), 100g cucumber' },
    { type: 'Dinner', name: 'Tofu & Vegetable Stir-Fry', kcal: 631, protein: 38, prep: '20 min', desc: 'Firm tofu cubes stir-fried with broccoli, peppers, and soy sauce, served on brown rice.', portion_size: '150g firm tofu, 200g broccoli, 150g peppers, 80g brown rice (dry), 1 tbsp soy sauce' },
  ...
  { day: 'Tuesday', meals: [
    { type: 'Breakfast', name: 'Scrambled Eggs on Wholemeal Toast', kcal: 285, protein: 20, prep: '10 min', desc: 'Two eggs scrambled with spinach and cherry tomatoes, on a slice of wholemeal toast.', portion_size: '2 eggs, 40g spinach, 100g cherry tomatoes, 1 slice wholemeal toast (40g)' },
    { type: 'Lunch', name: 'Red Lentil Soup', kcal: 432, protein: 28, prep: '30 min', desc: 'Thick red lentil soup with cumin, turmeric, and a wedge of wholemeal bread.', portion_size: '100g red lentils (dry), 1 slice wholemeal bread (40g), Cumin optional to taste (excluded from nutrition estimate), Turmeric optional to taste (excluded from nutrition estimate)' },
    { type: 'Dinner', name: 'Mushroom & Lentil Bolognese', kcal: 698, protein: 43, prep: '25 min', desc: 'Finely chopped mushrooms and green lentils in a rich tomato sauce, served over wholemeal spaghetti.', portion_size: '80g wholemeal spaghetti (dry), 100g green lentils (cooked), 200g mushrooms, 200g tinned tomatoes, Mixed herbs optional to taste (excluded from nutrition estimate)' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Halloumi & Quinoa Salad', kcal: 567, protein: 32, prep: '15 min', desc: 'Grilled reduced-fat halloumi over 80 g quinoa with roasted peppers, cucumber, and mint dressing.', portion_size: '80g reduced-fat halloumi, 80g quinoa (dry), 150g roasted peppers, 100g cucumber, 30g mint yogurt sauce' },
  ...
  { day: 'Thursday', meals: [
    ...
    { type: 'Lunch', name: 'Black Bean Tacos', kcal: 440, protein: 24, prep: '15 min', desc: 'Spiced black beans in two small wholemeal tortillas with shredded cabbage, salsa, and low-fat sour cream.', portion_size: '240g black beans (drained), 2 small wholemeal tortillas (60g), 80g shredded cabbage' },
    { type: 'Dinner', name: 'Paneer & Spinach Curry', kcal: 738, protein: 39, prep: '25 min', desc: 'Low-fat paneer with spinach in a tomato-based curry sauce, served with a small portion of brown rice.', portion_size: '150g low-fat paneer, 150g spinach, 60g brown rice (dry), 200ml tomato curry sauce' },
  ...
  { day: 'Friday', meals: [
    { type: 'Breakfast', name: 'Avocado & Egg Toast', kcal: 387, protein: 16, prep: '10 min', desc: 'Two slices wholemeal toast topped with half a mashed avocado and one poached egg.', portion_size: '2 slices wholemeal toast (80g), half avocado (75g), 1 egg' },
    { type: 'Lunch', name: 'Tofu Caesar Salad', kcal: 341, protein: 30, prep: '10 min', desc: 'Crispy baked tofu cubes over romaine lettuce with a light Caesar-style dressing and Parmesan.', portion_size: '150g firm tofu, 100g romaine lettuce, 1 tbsp Caesar dressing, 15g Parmesan' },
    { type: 'Dinner', name: 'Vegetarian Chilli', kcal: 574, protein: 26, prep: '25 min', desc: 'Kidney beans, black beans, and sweetcorn in a smoky tomato chilli. Served with brown rice.', portion_size: '120g kidney beans (drained), 120g black beans (drained), 80g sweetcorn, 60g brown rice (dry), 200g tinned tomatoes, Smoked paprika optional to taste (excluded from nutrition estimate)' },
    { type: 'Snack', name: 'Protein Yogurt & Walnuts', kcal: 211, protein: 20, prep: '2 min', desc: 'Protein yogurt pot with 15 g crushed walnuts.', portion_size: '150g protein yogurt, 15g crushed walnuts' },
  ], totals: { kcal: 1451, protein: 91 } },
  { day: 'Saturday', meals: [
    { type: 'Breakfast', name: 'Spinach & Feta Omelette', kcal: 341, protein: 29, prep: '10 min', desc: 'Three-egg omelette with wilted spinach, 30 g reduced-fat feta, and cherry tomatoes.', portion_size: '3 eggs, 60g wilted spinach, 30g reduced-fat feta, 100g cherry tomatoes' },
    { type: 'Lunch', name: 'Lentil & Roasted Veg Bowl', kcal: 637, protein: 37, prep: '30 min', desc: 'Roasted butternut squash, courgette, and peppers over green lentils with a tahini dressing.', portion_size: '150g butternut squash, 150g courgette, 150g peppers, 120g green lentils (cooked), 1 tbsp tahini' },
    { type: 'Dinner', name: 'Mushroom Risotto (lighter)', kcal: 401, protein: 17, prep: '35 min', desc: 'Arborio rice cooked with mixed mushrooms, low-fat crème fraîche, and Parmesan. Smaller portion.', portion_size: '70g Arborio rice (dry), 200g mixed mushrooms, 2 tbsp low-fat crème fraîche, 15g Parmesan' },
    { type: 'Snack', name: 'Edamame Pods', kcal: 242, protein: 22, prep: '5 min', desc: '200 g edamame pods, lightly salted.', portion_size: '200g edamame pods' },
  ...
  { day: 'Sunday', meals: [
    ...
    { type: 'Dinner', name: 'Nut Roast with Roasted Veg', kcal: 502, protein: 19, prep: '45 min', desc: 'Homemade walnut and lentil nut roast with roasted carrots, parsnips, and a vegetarian gravy.', portion_size: '150g nut roast, 150g carrots, 150g parsnips, 50ml vegetarian gravy' },
...
export const mealPlansData = {
    ...
    contextualLinks: [
      ...
      },
      {
        parts: [
          ...
          { text: ' for the same calorie target with Tesco prices and swaps. For a less aggressive deficit, compare the ' },
          { label: '1,800 calorie plan', to: '/meal-plan/1800-calorie-meal-plan' },
          { text: ' or build meals from the ' },
          { label: 'best low calorie foods UK guide', to: '/blog/best-low-calorie-foods-uk' },
          { text: '.' },
        ],
      },
      {
  ...
  '1800-calorie-meal-plan': {
    ...
    contextualLinks: [
      {
        parts: [
          { text: 'If you want a stricter cut, compare the ' },
          { label: '1,500 calorie meal plan', to: '/meal-plan/1500-calorie-meal-plan' },
          { text: '. Tesco shoppers can use the ' },
          { label: 'Tesco low calorie meal plan', to: '/meal-plan/tesco-low-calorie-meal-plan' },
          { text: ' for store-specific costs, while active adults may prefer the ' },
  ...
  '2000-calorie-meal-plan': {
    ...
    contextualLinks: [
      {
        parts: [
          { text: 'For a deeper calorie deficit, compare the ' },
          { label: '1,800 calorie plan', to: '/meal-plan/1800-calorie-meal-plan' },
          { text: ' or the ' },
          { label: '1,500 calorie plan', to: '/meal-plan/1500-calorie-meal-plan' },
          { text: '. If your priority is protein density rather than extra calories, use the ' },
          { label: 'high protein low calorie plan', to: '/meal-plan/high-protein-low-calorie-meal-plan' },
          { text: '.' },
        ],
      },
    ],
  ...
  'high-protein-low-calorie-meal-plan': {
    title: 'High Protein Low Calorie Meal Plan UK — 150g+ Protein',
    ...
    contextualLinks: [
      {
        parts: [
          { text: 'If you are building this shop at Tesco, pair this with the ' },
          { label: 'Tesco low calorie meal plan', to: '/meal-plan/tesco-low-calorie-meal-plan' },
          { text: ' for store-specific costs. For cheaper protein choices, use the ' },
          { label: 'cheap high protein foods UK guide', to: '/blog/best-cheap-high-protein-foods-uk' },
          { text: ' or drop to the simpler ' },
          { label: '1,500 calorie plan', to: '/meal-plan/1500-calorie-meal-plan' },
          { text: '.' },
        ],
      },
  ...
  'tesco-low-calorie-meal-plan': {
    ...
    tescoPricing: {
      heading: 'Tesco Price Snapshot for This 7-Day Plan',
      intro: 'Prices below use a Tesco online grocery check on 8 June 2026 and focus on own-brand, Aldi Price Match or commonly stocked Tesco items where possible. Treat them as a planning guide, not a checkout guarantee.',
      metrics: [
        { label: 'Estimated weekly Tesco basket', value: '\u00a340-45', note: 'Core plan items, before local variation' },
        { label: 'Cost per day', value: '\u00a35.75-\u00a36.45', note: 'Based on one adult for 7 days' },
        { label: 'Cost per main meal', value: '\u00a31.90-\u00a32.15', note: 'Breakfast, lunch and dinner' },
        { label: 'Basket cost per g protein', value: '5-6p', note: 'Total basket divided by estimated weekly protein' },
      ],
      proteinSources: [
        { item: 'Tesco 0% Fat Greek Style Yogurt 1 kg', price: '\u00a31.95', protein: '~100 g per tub', costPerGram: '~2.0p', bestUse: 'Breakfast bowls and snacks' },
        { item: 'Tesco Tuna Chunks in Spring Water 4 x 145 g', price: '\u00a32.49', protein: '~100 g per pack', costPerGram: '~2.5p', bestUse: 'Fast lunches, jacket potatoes and salads' },
        { item: 'Tesco British Chicken Breast Fillets 1 kg', price: '\u00a36.49', protein: '~240-300 g per pack', costPerGram: '~2-3p', bestUse: 'Batch-cooked lunches and dinners' },
        { item: 'Tesco Medium Free Range Eggs 12 pack', price: '\u00a32.85', protein: '~79 g per pack', costPerGram: '~3.6p', bestUse: 'Breakfasts, snacks and emergency meals' },
        { item: 'Tesco British Turkey Breast Mince 2% Fat 500 g', price: '\u00a34.90', protein: '~125 g per pack', costPerGram: '~3.9p', bestUse: 'Chilli, wraps and rice bowls' },
      ],
      lowCalorieFoods: [
        { item: 'Growers Harvest Mixed Vegetables 1 kg', price: '\u00a30.99', calories: '~58 kcal per 100 g', why: 'Very cheap volume for dinners' },
        { item: 'Tesco Large Broccoli Pack 500 g', price: '\u00a31.08', calories: '~40 kcal per 100 g', why: 'Filling, easy side dish' },
        { item: 'Tesco Perfectly Imperfect Frozen Mixed Berries 1 kg', price: '\u00a32.99', calories: '~55 kcal per 100 g', why: 'Low-calorie topping for oats and yogurt' },
        { item: 'Tesco Sweet Potatoes 1 kg', price: '\u00a31.19', calories: '~90 kcal per 100 g cooked', why: 'More filling than most snack carbs' },
        { item: 'Tesco Reduced Fat Houmous 200 g', price: '\u00a31.30', calories: '~84 kcal per 50 g', why: 'Controlled snack portion with carrots or cucumber' },
      ],
      clubcard: [
    ...
    budgetBreakdown: {
      heading: 'Tesco Weekly Budget Breakdown',
      intro: 'This basket is designed to cover the plan with budget-aware Tesco swaps. If you keep every premium example meal exactly as written, such as steak, prawns or cod, expect the basket to move toward the higher end.',
      rows: [
        { item: 'Tesco British Chicken Breast Fillets', quantity: '1 kg', price: '\u00a36.49', meals: '5-6 protein portions' },
        { item: 'Tesco Tuna Chunks in Spring Water', quantity: '4 x 145 g', price: '\u00a32.49', meals: '4 lunches or snacks' },
        { item: 'Tesco Medium Free Range Eggs', quantity: '12 pack', price: '\u00a32.85', meals: '5-6 breakfasts/snacks' },
        { item: 'Tesco 0% Fat Greek Style Yogurt', quantity: '1 kg', price: '\u00a31.95', meals: '5 breakfasts/snacks' },
        { item: 'Tesco British Turkey Breast Mince 2% Fat', quantity: '500 g', price: '\u00a34.90', meals: '3 chilli or wrap portions' },
        { item: 'Tesco 2 Boneless Salmon Fillets', quantity: '260 g', price: '\u00a35.15', meals: '2 dinners' },
        { item: "Grower's Harvest Porridge Oats", quantity: '1 kg', price: '\u00a30.85', meals: '12-15 breakfasts' },
        { item: 'Tesco Wholemeal Sliced Bread', quantity: '800 g', price: '~\u00a31.50', meals: '8-10 toast/sandwich portions' },
        { item: 'Tesco Easy Cook Brown Rice', quantity: '1 kg', price: '\u00a31.39', meals: '10+ carb portions' },
        { item: 'Tesco Sweet Potatoes', quantity: '1 kg', price: '\u00a31.19', meals: '5 side portions' },
        { item: 'Tesco Large Broccoli Pack', quantity: '500 g', price: '\u00a31.08', meals: '3 side portions' },
        { item: 'Growers Harvest Mixed Vegetables', quantity: '1 kg', price: '\u00a30.99', meals: '6-8 side portions' },
        { item: 'Tesco Filtered Skimmed Milk', quantity: '2 litres', price: '\u00a32.20', meals: 'Oats, smoothies and shakes' },
        { item: 'Tesco Perfectly Imperfect Frozen Mixed Berries', quantity: '1 kg', price: '\u00a32.99', meals: '10+ yogurt/oat toppings' },
    ...
    tescoSubstitutions: {
      ...
      rows: [
        { ingredient: 'Chicken breast', cheaper: 'Chicken thighs or drumsticks, skin removed', higherProtein: 'Turkey breast mince or extra chicken breast', vegetarian: 'Tofu, Quorn pieces or seitan' },
        { ingredient: 'Tinned tuna', cheaper: 'Tinned sardines or tuna single tins on Aldi Price Match', higherProtein: 'Chicken breast or extra tuna', vegetarian: 'Cottage cheese, tofu or chickpeas plus yogurt dressing' },
        { ingredient: 'Eggs', cheaper: 'Medium eggs instead of large eggs', higherProtein: 'Egg whites plus one whole egg', vegetarian: 'Tofu scramble' },
        { ingredient: '0% Greek yogurt', cheaper: '1 kg tub instead of single protein pots', higherProtein: 'Tesco High Protein Natural Yogurt', vegetarian: 'Skyr, cottage cheese or soy yogurt plus protein powder' },
        { ingredient: 'Turkey mince', cheaper: 'Turkey thigh mince or 5% pork mince if calories allow', higherProtein: '2% turkey breast mince', vegetarian: 'Vegetarian mince or red lentils' },
        { ingredient: 'Salmon or cod', cheaper: 'Frozen white fish, tinned tuna or chicken breast', higherProtein: 'Tuna, prawns or chicken breast', vegetarian: 'Tofu, tempeh or Quorn fillets' },
        { ingredient: 'Lean steak', cheaper: '5% beef mince used in a rice bowl', higherProtein: 'Turkey breast mince', vegetarian: 'Quorn mince or lentil chilli' },
        { ingredient: 'Brown rice', cheaper: 'Own-brand rice bought in 1 kg bags', higherProtein: 'Mix rice with lentils or edamame', vegetarian: 'Same swap works vegetarian' },
        { ingredient: 'Wholemeal bread or wraps', cheaper: 'Tesco own-brand loaf or pittas', higherProtein: 'High-protein wrap if on offer', vegetarian: 'Same swap works vegetarian' },
        { ingredient: 'Broccoli, spinach and salad', cheaper: 'Frozen mixed vegetables', higherProtein: 'Edamame, peas or spinach with yogurt dressing', vegetarian: 'Same swap works vegetarian' },
        { ingredient: 'Houmous', cheaper: 'Blend tinned chickpeas into a simple dip', higherProtein: 'Cottage cheese dip or Greek yogurt dip', vegetarian: 'Reduced fat houmous or bean dip' },
        { ingredient: 'Berries', cheaper: 'Perfectly Imperfect frozen berries', higherProtein: 'Berries with high-protein yogurt', vegetarian: 'Same swap works vegetarian' },
      ],
    },
    tescoConvenience: {
      intro: 'These are the Tesco-specific shortcuts most useful when you cannot cook but still want to stay near the plan.',
      rows: [
        { need: 'Cheapest Tesco breakfast under 300 calories', option: '40 g Grower\'s Harvest oats, 200 ml skimmed milk and 80-100 g frozen berries', nutrition: '~280 kcal, ~12 g protein', why: 'Usually under 70p per serving and keeps well as overnight oats' },
        { need: 'Highest protein Tesco lunch under 500 calories', option: '150 g cooked chicken breast, salad bag, cucumber, tomatoes and light yogurt dressing', nutrition: '~420-480 kcal, ~45 g protein', why: 'More protein per pound than most meal-deal mains' },
        { need: 'Best Tesco convenience foods for weight loss', option: 'Tuna tins, high-protein yogurt pots, bagged salad, microwave rice and frozen veg', nutrition: 'Varies by combination', why: 'Combines portion control with minimal cooking' },
        { need: 'Best Tesco ready meal under 500 calories', option: 'Tesco Calorie Controlled Chicken Tikka Masala 350 g', nutrition: '~353 kcal, ~23 g protein', why: 'Useful emergency dinner; add frozen veg if you need more volume' },
        { need: 'Best Tesco snacks under 100 calories', option: 'Rice cakes, cucumber or carrots, under-100-calorie snack multipacks, or a 50 g houmous portion', nutrition: '~15-100 kcal', why: 'Good for cravings, but pair with protein if hunger is the real issue' },
      ],
    },
    supermarketComparison: {
      intro: 'For pure price, Tesco is not always the cheapest. Its advantage is range, online availability, Clubcard, and the ability to build the whole plan in one basket.',
      rows: [
        { supermarket: 'Tesco', bestFor: 'One-basket online shop and Clubcard users', strength: 'Wide range, nutrition labels, Aldi Price Match staples, strong convenience options', watchOut: 'Premium fish, steak and branded snacks can quickly lift the basket' },
        { supermarket: 'Aldi', bestFor: 'Lowest-cost core meal prep', strength: 'Often cheapest for oats, eggs, chicken, rice and frozen vegetables', watchOut: 'Smaller range, less online convenience, fewer exact diet products' },
        { supermarket: 'Asda', bestFor: 'Big-four value with delivery', strength: 'Good budget range, full online shop, strong frozen and own-brand choices', watchOut: 'Can still be pricier than Aldi on core staples; rewards savings vary' },
      ],
    },
    methodology: {
      heading: 'Methodology and Price Check',
      points: [
    ...
    faq: [
      { q: 'How much does this Tesco meal plan cost per week?', a: 'The budget-aware basket is roughly \u00a340-45 for one person before local variation. Following every premium meal exactly as written, especially steak, prawns or cod, can push the shop closer to \u00a350.' },
      { q: 'What is the cheapest protein at Tesco for this plan?', a: 'The best value options are usually 0% Greek style yogurt, tinned tuna, chicken breast, eggs and turkey mince. The exact order changes with Clubcard and Aldi Price Match offers.' },
      { q: 'Can I use this Tesco plan for weight loss?', a: 'Yes, if 1,500 calories creates a sensible deficit for your body size and activity. If that feels too low, compare the 1,800 or 2,000 calorie plans rather than forcing a target you cannot sustain.' },
      { q: 'Does Tesco sell everything I need for this plan?', a: 'A large Tesco or online shop should cover the basket. Smaller Express stores may miss items such as turkey mince, larger yogurt tubs, frozen berries or calorie-controlled ready meals.' },
    ],
    related: [
      { slug: '1500-calorie-meal-plan', label: '1500 Calorie Plan' },
      { slug: '1800-calorie-meal-plan', label: '1800 Calorie Plan' },
      { slug: '2000-calorie-meal-plan', label: '2000 Calorie Plan' },
      { slug: 'high-protein-low-calorie-meal-plan', label: 'High Protein Plan' },
    ],
    blogLinks: [
      { path: '/blog/tesco-low-calorie-shopping-list', label: 'Tesco Low Calorie Shopping List' },
      { path: '/blog/best-cheap-high-protein-foods-uk', label: 'Cheap High Protein Foods UK' },
    ...
    priceEstimate: '\u00a340-45 per week (Tesco basket, checked 8 June 2026)',
  },

  'vegetarian-low-calorie-meal-plan': {
    title: 'Vegetarian Low Calorie Meal Plan UK — High Protein (Free)',
  ...
  'aldi-low-calorie-meal-plan': {
    ...
    summary: {
      supermarkets: 'Aldi',
      supermarket: 'Aldi',
      bestFor: 'Budget fat loss, Aldi shoppers',
      prepDifficulty: 'Easy (15–25 min)',
    },
  ...
  'vegan-low-calorie-meal-plan': {
    title: 'Vegan Low Calorie Meal Plan UK — Plant-Based (Free)',
    description: 'Vegan meal plan for weight loss. 60-70g plant-based protein daily. 1500 calories. Lose weight on a vegan diet. Generate your free plan.',
  ...
  'aldi-1800-calorie-meal-plan': {
    title: 'Aldi 1800 Calorie Meal Plan UK — High Protein (Free)',
    description: 'Aldi 1800 calorie meal plan UK. Budget-friendly at £35-45/week. 100-130g protein daily for sustainable weight loss. Generate your free plan.',
  ...
  'aldi-high-protein-meal-plan': {
    ...
    description: 'High protein Aldi meal plan UK for gym-goers. 140-170g protein daily, £35-45/week, budget-friendly. Lose fat, build muscle. Generate yours free.',
  ...
  'tesco-1800-calorie-meal-plan': {
    title: 'Tesco 1800 Calorie Meal Plan UK — Weight Loss (Free)',
    description: 'Tesco 1800 calorie meal plan UK. High-protein, sustainable weight loss using Tesco own-brand ingredients. Clubcard savings included. Generate yours free.',
  ...
  'tesco-high-protein-meal-plan': {
    ...
    description: 'Tesco high protein meal plan for gym-goers & weight loss. 140-170g protein daily. Tesco Clubcard savings. Build muscle, lose fat. Generate yours free.',
  ...
  'asda-1800-calorie-meal-plan': {
    ...
    description: 'Asda 1800 calorie meal plan for weight loss. High-protein meals on a budget. ~£38-48/week, simple recipes, full shopping list. Generate yours free.',
  ...
  'asda-1500-calorie-meal-plan': {
    title: 'Asda 1500 Calorie Meal Plan UK — Weight Loss (Free)',
    description: 'Budget Asda meal plan for weight loss at £35-45/week. 1500 calories, high protein, simple recipes. Generate your free 7-day plan.',
  ...
  'sainsburys-1800-calorie-meal-plan': {
    title: "Sainsbury's 1800 Calorie Meal Plan UK — Weight Loss (Free)",
    description: "Sainsbury's 1800 calorie meal plan for weight loss. Nectar card savings. High-protein, sustainable, £42-52/week. Generate your free plan.",
  ...
  'sainsburys-low-calorie-meal-plan': {
    title: "Sainsbury's 1500 Calorie Meal Plan UK — Free 7-Day",
    description: "Sainsbury's 1500 calorie meal plan for weight loss. Nectar savings, high protein, simple meals. £38-48/week. Generate your free plan.",
  ...
  'morrisons-low-calorie-meal-plan': {
    title: 'Morrisons 1500 Calorie Meal Plan UK — Weight Loss (Free)',
    description: 'Morrisons 1500 calorie meal plan. High protein, Market Street fresh counters. ~£38-48/week, simple meals. Generate your free plan.',
  ...
  'lidl-1800-calorie-meal-plan': {
    ...
    description: 'Lidl 1800 calorie meal plan for weight loss. Budget-friendly at £35-45/week. High protein, simple meals. Generate your free plan.',
  ...
  'morrisons-1800-calorie-meal-plan': {
    title: 'Morrisons 1800 Calorie Meal Plan UK — Weight Loss (Free)',
    description: 'Morrisons 1800 calorie meal plan. Market Street counters, Morrisons More savings. High protein, ~£42-52/week. Generate your free plan.',
  ...
  'iceland-budget-meal-plan': {
    title: 'Iceland Budget Meal Plan UK — Under £30/week (Free)',
    description: 'Budget meal plan using Iceland frozen foods. Under £30/week, high protein, simple recipes. Lose weight cheaply. Generate your free plan.',
  ...
  '2500-calorie-meal-plan': {
    title: '2500 Calorie Meal Plan UK — Muscle Gain & Bulking (Free)',
    description: 'Free 2500 calorie meal plan for active UK adults. Muscle gain, maintenance, high protein. Simple recipes with supermarket ingredients. Generate yours free.',
  ...
  'cheap-student-meal-plan-uk': {
    ...
    description: 'Cheap student meal plan for healthy eating on a budget. Under £30/week, high protein, simple recipes, minimal cooking. Generate your free plan.',
  ...
  'high-protein-vegetarian-meal-plan-uk': {
    ...
    description: 'High protein vegetarian meal plan for weight loss. 100-130g protein daily from eggs, dairy, tofu, legumes. Generate your free plan.',
  ...
  'budget-bodybuilding-meal-plan-uk': {
    ...
    description: 'Budget bodybuilding meal plan for muscle gain. High protein at 2000 calories, £40-55/week. Cheap supermarket staples. Generate your free plan.',
  ...
  'gym-beginner-meal-plan-uk': {
    title: 'Gym Beginner Meal Plan UK — Start Training (Free 7-Day)',
    description: 'Gym beginner meal plan for weight training. 1800 calories, 110-130g protein. Simple recipes for muscle recovery. Generate your free plan.',
  ...
  'budget-fat-loss-meal-plan-uk': {
    title: 'Budget Fat Loss Meal Plan UK — Under £30/week (Free)',
    description: 'Budget fat loss meal plan using cheap supermarket staples. Under £30/week, 1500 calories, high protein. Generate your free 7-day plan.',
  ...
  'muscle-gain-meal-plan-uk': {
    title: 'Muscle Gain Meal Plan UK — Clean Bulking 2500 kcal (Free)',
    description: 'Free muscle gain meal plan for clean bulking. 2500 calories, 150-180g protein, everyday ingredients. Build lean muscle. Generate yours free.',
  ...
  'cheap-high-protein-meal-plan-uk': {
    title: 'Cheap High Protein Meal Plan UK — 140g+ Under £30/week',
    description: 'Cheap high protein meal plan for fat loss. 140-170g protein daily using budget staples. Under £30/week at Aldi. Generate your free 7-day plan.',
  ...
  'low-effort-meal-plan-uk': {
    title: 'Low Effort Meal Plan UK — 15 Min Meals (Free 7-Day)',
    description: 'Low effort meal plan for busy people. Simple meals under 15 minutes. 1800 calories, high protein. No fancy cooking skills needed. Generate yours free.',
  ...
  'busy-professional-meal-plan-uk': {
    ...
    description: 'Busy professional meal plan for working adults. Batch cooking, 20-min dinners, grab-and-go lunches. High protein weight loss. Generate yours free.',
