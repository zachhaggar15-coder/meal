...
export const PLAN_1500 = [
  ...
  { day: 'Tuesday', meals: [
    ...
    { type: 'Lunch', name: 'Homemade Lentil Soup', kcal: 463, protein: 26, prep: '30 min', desc: 'Red lentil and carrot soup seasoned with cumin and coriander, served with a small wholemeal roll.', portion_size: '80g red lentils (dry), 100g carrots, 1 small roll (60g)' },
    { type: 'Dinner', name: 'Baked Salmon with Broccoli & New Potatoes', kcal: 452, protein: 37, prep: '20 min', desc: 'Salmon fillet baked with lemon and dill, served with steamed broccoli and boiled new potatoes.', portion_size: '150g salmon fillet, 150g new potatoes, 150g broccoli' },
  ...
  { day: 'Thursday', meals: [
    ...
    { type: 'Lunch', name: 'Prawn & Avocado Salad', kcal: 205, protein: 24, prep: '10 min', desc: 'King prawns tossed with mixed leaves, half an avocado, cucumber, and lemon dressing.', portion_size: '120g king prawns, ½ avocado (60g), 80g mixed leaves, 100g cucumber' },
  ...
  { day: 'Saturday', meals: [
    ...
    { type: 'Dinner', name: 'Grilled Lean Beef Steak with Roasted Veg', kcal: 290, protein: 37, prep: '15 min', desc: 'Lean sirloin steak grilled to your liking, with roasted courgette, peppers, and cherry tomatoes.', portion_size: '150g lean sirloin steak, 200g roasted veg' },
  ...
  { day: 'Sunday', meals: [
    ...
    { type: 'Lunch', name: 'Leftover Steak Salad', kcal: 165, protein: 24, prep: '5 min', desc: 'Sliced leftover steak over mixed leaves with cherry tomatoes and a balsamic dressing.', portion_size: '100g sliced steak, 80g mixed leaves, 100g cherry tomatoes' },
...
export const PLAN_HIGH_PROTEIN = [
  { day: 'Monday', meals: [
    ...
    { type: 'Lunch', name: 'Tuna & Egg White Salad', kcal: 412, protein: 88, prep: '10 min', desc: 'Two tins of tuna with three hard-boiled egg whites, mixed leaves, cucumber, and lemon dressing.', portion_size: '2 tins tuna (290g drained), 3 egg whites, 80g mixed leaves, 100g cucumber' },
  ...
  { day: 'Tuesday', meals: [
    ...
    { type: 'Dinner', name: 'Baked Salmon with Asparagus', kcal: 477, protein: 37, prep: '20 min', desc: 'Salmon fillet baked with lemon and herbs, served with a bunch of roasted asparagus and a small side of brown rice.', portion_size: '150g salmon fillet, 200g asparagus, 40g brown rice (dry)' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Turkey & Lentil Soup', kcal: 352, protein: 44, prep: '30 min', desc: 'Ground turkey and red lentil soup with spinach and mild spices.', portion_size: '150g turkey mince, 40g red lentils (dry), 80g spinach' },
  ...
  { day: 'Thursday', meals: [
    ...
    { type: 'Dinner', name: 'Lean Beef Stir-Fry', kcal: 509, protein: 52, prep: '15 min', desc: '200 g lean beef strips stir-fried with broccoli, peppers, and a low-sodium soy sauce. Small portion of brown rice.', portion_size: '200g lean beef strips, 35g brown rice (dry), 150g broccoli, 100g peppers' },
  ...
  { day: 'Saturday', meals: [
    ...
    { type: 'Lunch', name: 'Prawn & Quinoa Bowl', kcal: 311, protein: 32, prep: '10 min', desc: 'King prawns over 80 g quinoa with avocado, cucumber, and a ginger-soy dressing.', portion_size: '150g king prawns, 80g quinoa (cooked), ½ avocado (60g), 100g cucumber' },
...
export const PLAN_VEGAN = [
  { day: 'Monday', meals: [
    ...
    { type: 'Dinner', name: 'Tofu Stir-Fry with Brown Rice', kcal: 517, protein: 39, prep: '20 min', desc: 'Firm tofu cubes stir-fried with broccoli, peppers, and low-sodium soy sauce, served on brown rice.', portion_size: '200g firm tofu, 40g brown rice (dry), 150g broccoli, 100g peppers' },
  ...
  { day: 'Tuesday', meals: [
    ...
    { type: 'Dinner', name: 'Mushroom & Lentil Bolognese', kcal: 436, protein: 26, prep: '25 min', desc: 'Finely chopped mushrooms and green lentils in a rich tomato sauce, served over wholemeal spaghetti.', portion_size: '80g wholemeal spaghetti (dry), 200g mushrooms, 100g cooked lentils' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Tofu & Quinoa Buddha Bowl', kcal: 441, protein: 29, prep: '15 min', desc: 'Baked marinated tofu over 80 g quinoa with roasted peppers, cucumber, avocado, and tahini dressing.', portion_size: '150g baked tofu, 80g quinoa (cooked), 100g roasted peppers, ½ avocado (60g)' },
  ...
  { day: 'Friday', meals: [
    ...
    { type: 'Dinner', name: 'Vegetarian Chilli (Vegan)', kcal: 488, protein: 28, prep: '25 min', desc: 'Kidney beans, black beans, and lentils in a smoky tomato chilli, served with brown rice.', portion_size: '120g kidney beans, 120g black beans, 80g cooked lentils, 40g brown rice (dry)' },
  ...
  { day: 'Saturday', meals: [
    ...
    { type: 'Lunch', name: 'Lentil & Roasted Veg Bowl', kcal: 230, protein: 13, prep: '30 min', desc: 'Roasted butternut squash, courgette, and peppers over green lentils with tahini dressing.', portion_size: '100g cooked lentils, 150g butternut squash, 100g courgette, 100g peppers' },
  ...
  { day: 'Sunday', meals: [
    ...
    { type: 'Dinner', name: 'Lentil Bolognese with Wholemeal Pasta', kcal: 448, protein: 26, prep: '30 min', desc: 'Brown lentils in a rich tomato sauce with mushrooms and herbs, served over wholemeal pasta.', portion_size: '80g wholemeal pasta (dry), 120g cooked lentils, 150g mushrooms' },
...
export const PLAN_VEGETARIAN = [
  { day: 'Monday', meals: [
    ...
    { type: 'Lunch', name: 'Chickpea & Spinach Salad', kcal: 406, protein: 24, prep: '10 min', desc: 'Tinned chickpeas, baby spinach, cherry tomatoes, cucumber, red onion, and lemon-tahini dressing.', portion_size: '240g chickpeas (drained), 60g baby spinach, 150g cherry tomatoes, 1 tbsp tahini (15g)' },
  ...
  { day: 'Tuesday', meals: [
    ...
    { type: 'Lunch', name: 'Red Lentil Soup', kcal: 432, protein: 28, prep: '30 min', desc: 'Thick red lentil soup with cumin, turmeric, and a wedge of wholemeal bread.', portion_size: '100g red lentils (dry), 1 slice wholemeal bread (40g)' },
    { type: 'Dinner', name: 'Mushroom & Lentil Bolognese', kcal: 662, protein: 42, prep: '25 min', desc: 'Finely chopped mushrooms and green lentils in a rich tomato sauce, served over wholemeal spaghetti.', portion_size: '80g wholemeal spaghetti (dry), 100g green lentils (cooked), 200g mushrooms' },
  ...
  { day: 'Wednesday', meals: [
    ...
    { type: 'Lunch', name: 'Halloumi & Quinoa Salad', kcal: 549, protein: 31, prep: '15 min', desc: 'Grilled reduced-fat halloumi over 80 g quinoa with roasted peppers, cucumber, and mint dressing.', portion_size: '80g reduced-fat halloumi, 80g quinoa (dry), 150g roasted peppers, 100g cucumber' },
  ...
  { day: 'Friday', meals: [
    ...
    { type: 'Dinner', name: 'Vegetarian Chilli', kcal: 538, protein: 24, prep: '25 min', desc: 'Kidney beans, black beans, and sweetcorn in a smoky tomato chilli. Served with brown rice.', portion_size: '120g kidney beans (drained), 120g black beans (drained), 80g sweetcorn, 60g brown rice (dry)' },
  ...
  { day: 'Sunday', meals: [
    ...
    { type: 'Dinner', name: 'Nut Roast with Roasted Veg', kcal: 489, protein: 19, prep: '45 min', desc: 'Homemade walnut and lentil nut roast with roasted carrots, parsnips, and a vegetarian gravy.', portion_size: '150g nut roast, 150g carrots, 150g parsnips' },
