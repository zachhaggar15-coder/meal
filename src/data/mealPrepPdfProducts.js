...
export const MEAL_PREP_PDF_PRODUCTS = {
  ...
  'aldi-bundle': {
    ...
    description: 'Get both dinner and high-protein plans for under £15—switch between them weekly based on your mood or training week. Same dinners, double the choice and flexibility.',
