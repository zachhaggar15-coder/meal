...
export const CONTAINER_PRODUCTS = {
  ...
  'moonmoon-1500ml-silicone-bags': {
    name: 'Moonmoon Reusable Silicone Food Storage Bags (Set of 2, 1500ml)',
    shortName: 'Moonmoon 1500ml bags',
    asin: 'B09WDYT3L3',
    priceBand: 'Reusable silicone: check live Amazon price',
    material: 'Silicone',
    ...
    summary:
      'A two-bag 1500ml reusable silicone set for flat-freezing larger portions when rigid tubs waste freezer space.',
    keyFeatures: [
      'Large 1500ml capacity suits soups, sauces and batch-cooked mince',
      'Reusable silicone format for freezer rotation',
      'Stand-up shape helps filling before laying the bag flat to freeze',
    ],
    watchOut: 'Large silicone bags need thorough drying before storing so odours do not build up.',
    lastChecked: '22 July 2026',
  },
  'moonmoon-mixed-silicone-bags': {
    name: 'Moonmoon Reusable Silicone Food Storage Bags (Set of 3)',
    shortName: 'Moonmoon mixed bags',
    asin: 'B0GR6DNKMS',
    priceBand: 'Reusable silicone: check live Amazon price',
    material: 'Silicone',
    ...
    summary:
      'A mixed reusable silicone set with meal, snack and sauce-sized bags, useful when you want bags alongside rigid lunch containers.',
    keyFeatures: [
      'Mixed capacities cover 900ml, 470ml and 330ml jobs',
      'Useful for smoothie packs, snacks, sauces and smaller freezer portions',
      'Reusable silicone bags reduce reliance on disposable freezer bags',
    ],
    watchOut: 'The smaller bags are not full lunch containers; use them for sides, sauces and snacks.',
    lastChecked: '22 July 2026',
  },
  'moonmoon-900ml-silicone-bags': {
    name: 'Moonmoon Reusable Silicone Food Storage Bags (Set of 2, 900ml)',
    shortName: 'Moonmoon 900ml bags',
    asin: 'B0CR6P2PLD',
    priceBand: 'Reusable silicone: check live Amazon price',
    material: 'Silicone',
    ...
    summary:
      'A slimmer 900ml reusable silicone bag set for one-person portions, smoothie prep and smaller freezer batches.',
    keyFeatures: [
      '900ml size suits many individual freezer portions',
      'Slim format helps flat-freezing and quicker defrosting',
      'Reusable silicone is useful for repeat smoothie or soup prep',
    ],
    watchOut: 'Choose the 1500ml option instead for bulky stews, family portions or large sauce batches.',
    lastChecked: '22 July 2026',
  },
  'brighter-goods-mixed-silicone-bags': {
    name: 'Brighter Goods Reusable Silicone Food Storage Bags (3 Pack)',
    shortName: 'Brighter Goods bags',
    asin: 'B0G2M4VW8X',
    priceBand: 'Reusable silicone: check live Amazon price',
    material: 'Silicone',
    ...
    summary:
      'A mixed reusable silicone bag set to compare when you want one purchase to cover freezer portions and smaller kitchen storage.',
    keyFeatures: [
      'Mixed three-pack format covers more than one storage job',
      'Reusable silicone construction for freezer and fridge prep',
      'Useful alternative if the Moonmoon size mix is not right',
    ],
    watchOut: 'Check the live listing for the exact capacity mix before buying.',
    lastChecked: '22 July 2026',
  },
  'tuffa-1500ml-silicone-bags': {
    name: 'Tuffa Reusable Silicone Food Storage Bags (3 Pack, 1.5L)',
    shortName: 'Tuffa 1.5L bags',
    asin: 'B0FTHLL9RT',
    priceBand: 'Reusable silicone: check live Amazon price',
    material: 'Silicone',
    ...
    summary:
      'A larger 1.5L silicone freezer-bag set for people who want several meal-sized bags for flat-freezing in one go.',
    keyFeatures: [
      '1.5L bag format suits bigger batch portions',
      'Locking-bar style closure helps with thicker sauces and soups',
      'Reusable silicone design works alongside glass or plastic lunch boxes',
    ],
    watchOut: 'Locking bars add another part to clean, dry and keep matched with the bags.',
    lastChecked: '22 July 2026',
  },
...
const CONTAINER_PRODUCT_DETAILS = {
  ...
  'moonmoon-1500ml-silicone-bags': {
    setSize: '2 pack',
    layout: '1500ml reusable bags',
    sealType: 'Self-seal silicone closure',
    reheatFit: 'Good for freezer storage; follow listing guidance before microwaving or heating',
    storageFit: 'Best for flat-freezing larger liquid or sauce-heavy portions',
    buyIf: 'You want large reusable bags for soups, sauces, cooked mince or family-style freezer portions.',
    avoidIf: 'You mainly need fork-and-eat lunch boxes for work.',
    pros: ['Large capacity', 'Flat-freezes efficiently', 'Reusable silicone format'],
    cons: ['Needs careful washing and drying', 'Less rigid protection than a tub'],
  },
  'moonmoon-mixed-silicone-bags': {
    setSize: '3 pack',
    layout: '900ml, 470ml and 330ml bags',
    sealType: 'Leak-resistant silicone seal',
    reheatFit: 'Good for freezing and storing; follow listing guidance before microwaving or oven use',
    storageFit: 'Best for combining meal portions, smoothie packs, snacks and sauces',
    buyIf: 'You want a first reusable freezer-bag set without buying only large bags.',
    avoidIf: 'You need every bag to hold a full dinner portion.',
    pros: ['Useful size spread', 'Good starter set', 'Covers sauces and snacks too'],
    cons: ['Only one larger bag', 'Smaller bags are not full-meal sizes'],
  },
  'moonmoon-900ml-silicone-bags': {
    setSize: '2 pack',
    layout: '900ml reusable bags',
    sealType: 'Resealable silicone closure',
    reheatFit: 'Good for single portions; follow listing guidance before heating',
    storageFit: 'Best for one-person flat-freezer meals and smoothie packs',
    buyIf: 'You usually freeze single servings rather than big family batches.',
    avoidIf: 'You want larger bags for stew, soup or two-person portions.',
    pros: ['Good individual portion size', 'Slim freezer footprint', 'Reusable for repeat prep'],
    cons: ['Too small for bulky meals', 'Only two bags in the set'],
  },
  'brighter-goods-mixed-silicone-bags': {
    setSize: '3 pack',
    layout: 'Mixed silicone bags',
    sealType: 'Press-lock style seal',
    reheatFit: 'Good for freezer and fridge prep; follow listing guidance before microwaving',
    storageFit: 'Best for buyers comparing a mixed-size silicone freezer-bag set',
    buyIf: 'You want reusable freezer bags for both meals and smaller kitchen storage.',
    avoidIf: 'You want a set where every bag is the same large size.',
    pros: ['Mixed storage coverage', 'Reusable silicone', 'Good alternative size mix'],
    cons: ['Exact capacities need checking', 'Mixed sets can leave you short of full-meal bags'],
  },
  'tuffa-1500ml-silicone-bags': {
    setSize: '3 pack',
    layout: '1.5L reusable bags',
    sealType: 'Locking-bar closure',
    reheatFit: 'Good for freezer-first prep; follow listing guidance before microwaving, boiling or heating',
    storageFit: 'Best for several larger flat-freezer portions at once',
    buyIf: 'You batch cook sauces, soups or larger portions and want multiple big bags.',
    avoidIf: 'You dislike separate closure bars or need tiny snack bags.',
    pros: ['Three large bags', 'Strong big-batch fit', 'Useful for sauce-heavy meals'],
    cons: ['Closure bars must be kept matched', 'Large bags take longer to wash and dry'],
  },
  'harbour-housewares-glass-5-pack': {
    setSize: '5 pack',
    layout: '1 compartment',
...
const LONG_TAIL_CONTAINER_GUIDES = {
  ...
  'freezer-bags': {
    ...
    title: 'Freezer Bags for Meal Prep UK - Best Reusable Silicone Bags',
    description:
      'Compare freezer bags for meal prep UK: reusable silicone bags for flat-freezing soups, sauces, smoothie packs and batch-cooked portions with Amazon UK affiliate picks.',
    h1: 'Freezer Bags for Meal Prep UK',
    kicker: 'Freezer bag guide',
    priceBand: 'Reusable silicone freezer bag picks',
    summaryText:
      'Compare five reusable silicone freezer bag sets for flat-freezing soups, sauces, smoothie packs, snacks and batch portions.',
    quickComparisonIntro:
      'Quickly compare reusable freezer bag picks by capacity, seal style and flat-freezer use. The full buying notes continue below.',
    fastPickText:
      'Start with Moonmoon 1500ml bags if you want the largest all-round flat-freezer pick, then scroll for all five freezer-bag options and buying notes.',
    productGridTitle: 'Best freezer bags for meal prep UK',
    productGridIntro:
    ...
    sections: [
      {
        h2: 'Who should buy freezer bags for meal prep?',
        paragraphs: [
          'Choose freezer bags if your freezer drawer fills with bulky half-empty tubs. A reusable silicone bag can be filled, sealed, laid flat on a tray, frozen thin and then stacked upright or flat once solid.',
          'They are best for food that can spread into a thin layer: soups, sauces, chilli, bolognese, cooked mince, smoothie fruit packs, marinades and small freezer portions. For delicate food that could be crushed, a rigid container is still the better choice.',
        ],
      },
      {
        h2: 'Freezer bags vs freezer-safe containers',
        paragraphs: [
          'Freezer bags win on space and thaw speed. A flat portion has less depth for cold or heat to travel through, so it stores neatly and defrosts more predictably than a deep tub.',
          'Containers still win for fork-and-eat lunches, microwave reheating and meals with separate components. The best setup is usually both: freezer bags for overflow and sauces, containers for the meals you carry or reheat most often.',
        ],
      },
      {
        h2: 'What size freezer bag should you buy?',
        paragraphs: [
          'A 1.5L bag is the most useful size for soups, sauces, cooked mince and two-person batch portions. Around 900ml works better for single servings and smoothie packs. Smaller bags are useful for snacks, sauces, fruit and chopped vegetables, but they are not full-meal containers.',
          'If you are only buying one set, choose the size that matches the food you freeze most. Big bags are more flexible for batch cooking; mixed sets are tidier when you prep meals, snacks and sauces together.',
        ],
      },
      {
        h2: 'How to freeze meal prep in bags without leaks',
        paragraphs: [
          'Fill the bag no more than two-thirds full, push out excess air, seal carefully and lay it flat on a tray before putting it in the freezer. Once the food is solid, remove the tray and stack the flat portions.',
          'Label the bag or add masking tape with the meal name and date. Wash and dry reusable silicone bags fully before storing them closed, especially after curry, tomato sauce or marinades.',
        ],
      },
      {
        h2: 'Freezer bag verdict',
        paragraphs: [
          'Buy reusable silicone freezer bags when freezer space is the bottleneck. Keep rigid tubs for structured lunches, and add larger freezer bags for flat-freezing sauces, soups and batch-cooked meals.',
        ],
      },
    ],
    faq: [
      {
        q: 'Are reusable silicone freezer bags worth it for meal prep?',
        a: 'Yes, if you freeze food regularly and want to save space. They cost more upfront than disposable bags, but reusable silicone bags are better for repeated flat-freezing, washing and weekly rotation.',
      },
      {
        q: 'Can freezer bags replace meal prep containers?',
        a: 'Not completely. Freezer bags are best for flat-freezing and storage. Rigid containers are better for work lunches, separate meal components and eating or reheating directly from the container.',
      },
      {
        q: 'Can silicone freezer bags go in the microwave?',
        a: 'Some silicone freezer bags are listed as microwave suitable, but you should follow the exact product instructions. If unsure, defrost in the bag and transfer food to a microwave-safe container before reheating.',
      },
      {
