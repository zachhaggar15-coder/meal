...
export const CONTAINER_GUIDES = {
  budget: {
    ...
    title: 'Budget Meal Prep Containers UK - Compare 6 Cheap Amazon Picks',
    description:
      'Compare six budget meal prep containers, boxes and tubs for UK batch cooking, with pros, cons, buyer fit, storage notes and Amazon UK affiliate links.',
