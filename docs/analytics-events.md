...
| `guide_callout_clicked` | A reader follows an in-article guide callout (`guideCallout` on a blog section) | `source_page`, `placement`, `target_route` | Which articles actually send readers on to the buying guide? |
